...
async def rooms_button_mute_unmute(inter: disnake.Interaction, room: disnake.VoiceChannel, channel_settings: disnake.TextChannel) -> None:
    await inter.response.defer()

    embed = disnake.Embed(
        description="Напишите никнейм участника, которого нужно замутить/размутить.\n"
                    "Например: `@username`",
